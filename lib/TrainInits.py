...
def print_require_grad_parameters(model):
    trainable_num = sum(p.nelement() for p in model.parameters() if p.requires_grad)
    print('Total trainable params num: {}'.format(trainable_num))
